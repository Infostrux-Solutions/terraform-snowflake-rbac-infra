...
### Pre-commit for Checkov

In order to streamline the development of infrastructure as code via Terraform, we installed a [pre-commit](https://pre-commit.com/) feature, leveraging the [Checkov checks](https://www.checkov.io/4.Integrations/pre-commit.html) on the Terraform Code.
